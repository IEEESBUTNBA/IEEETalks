...
{
    public class MockSessionDataInitializer : ISessionDataInitializer
    {
        private readonly ISession _session;

        public MockSessionDataInitializer(ISession session)
        {
            _session = session;
        }
        ...
        {
            foreach (var evnt in InitiaData())
            {
                _session.Store(evnt.Id, evnt);
            }
        }

        private List<Event> InitiaData()
        {
